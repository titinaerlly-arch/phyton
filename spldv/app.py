...
def solve_and_plot(a1, b1, c1, a2, b2, c2):
    ...
    if D != 0:
        ...
        explanation = "Determinan $D = 0$ tetapi $D_x \\ne 0$ atau $D_y \\ne 0$. Kedua garis **Sejajar** (memiliki gradien yang sama) dan tidak pernah berpotongan."
        ...
        explanation = "Determinan $D = D_x = D_y = 0$. Kedua persamaan adalah kelipatan satu sama lain. Garis **Berimpit**, sehingga setiap titik pada garis adalah solusi."
